...
{
    [Query]
    public void ForEach(ref T1 t1, ref T2 t2)
    {
        method(ref t1, ref t2);
    }
}
...
{
    [Query]
    public void ForEach(ref T1 t1, ref T2 t2, ref T3 t3)
    {
        method(ref t1, ref t2, ref t3);
    }
}
...
{
    [Query]
    public void ForEach(ref T1 t1, ref T2 t2, ref T3 t3, ref T4 t4)
    {
        method(ref t1, ref t2, ref t3, ref t4);
    }
}