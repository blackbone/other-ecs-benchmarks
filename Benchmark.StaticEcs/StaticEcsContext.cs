...
public sealed class StaticEcsContext : IBenchmarkContext<W.Entity>
{
    ...
    public void Warmup<T1>(in int poolId) where T1 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
    {
        TryRegisterComponent<T1>();
    }

    public void Warmup<T1, T2>(in int poolId) where T1 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T2 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
    {
        TryRegisterComponent<T1>();
        TryRegisterComponent<T2>();
    }

    public void Warmup<T1, T2, T3>(in int poolId) where T1 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T2 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T3 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
    {
        TryRegisterComponent<T1>();
        TryRegisterComponent<T2>();
    ...
    public void Warmup<T1, T2, T3, T4>(in int poolId) where T1 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T2 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T3 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T4 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
    {
        TryRegisterComponent<T1>();
        TryRegisterComponent<T2>();
        TryRegisterComponent<T3>();
    ...
    public void CreateEntities<T1>(in W.Entity[] entities, in int poolId, in T1 c1)
        where T1 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
    {
    ...
    public void CreateEntities<T1, T2, T3>(in W.Entity[] entities, in int poolId, in T1 c1,
        in T2 c2, in T3 c3) where T1 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T2 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T3 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
    {
        var entType = ResolveEntityType(poolId);
    ...
    public void CreateEntities<T1, T2, T3, T4>(in W.Entity[] entities, in int poolId, in T1 c1,
        in T2 c2, in T3 c3, in T4 c4) where T1 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T2 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T3 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T4 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
    {
    ...
    public void AddComponent<T1, T2, T3>(in W.Entity[] entities, in int poolId, in T1 c1, in T2 c2,
        in T3 c3) where T1 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T2 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T3 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
    {
        for (var i = 0; i < entities.Length; i++)
    ...
    public void RemoveComponent<T1>(in W.Entity[] entities, in int poolId) where T1 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
    {
        for (var i = 0; i < entities.Length; i++)
    ...
    public int CountWith<T1>(in int poolId) where T1 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
    {
        return W.Query<All<T1>>().EntitiesCount();
    }

    public int CountWith<T1, T2>(in int poolId) where T1 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T2 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
    {
        return W.Query<All<T1, T2>>().EntitiesCount();
    }

    public int CountWith<T1, T2, T3>(in int poolId) where T1 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T2 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T3 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
    {
    ...
    public int CountWith<T1, T2, T3, T4>(in int poolId) where T1 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T2 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T3 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
        where T4 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
    {
    ...
    public bool GetSingle<T1>(in W.Entity e, in int poolId, ref T1 c1) where T1 : struct, Scellecs.Morpeh.IComponent, IEcsComponent, Friflo.Engine.ECS.IComponent, IComponent
    {
        c1 = e.Ref<T1>();
        return true;
    }
