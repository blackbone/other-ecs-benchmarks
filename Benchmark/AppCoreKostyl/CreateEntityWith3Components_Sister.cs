...
{
    [ArtifactsPath(".benchmark_results/CreateEntityWith3Components")]
    [BenchmarkCategory(Categories.PerInvocationSetup)]
    [MemoryDiagnoser]
    public class CreateEntityWith3Components_Sister : IBenchmark
    {
        ...
        {
            Context?.Lock();
            Context?.CreateEntities(_entitySet, 0, new Component1(), new Component2(), new Component3());
            Context?.Commit();
        }
    }
}