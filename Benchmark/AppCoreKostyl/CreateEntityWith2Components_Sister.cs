...
{
    [ArtifactsPath(".benchmark_results/CreateEntityWith2Components")]
    [BenchmarkCategory(Categories.PerInvocationSetup)]
    [MemoryDiagnoser]
    public class CreateEntityWith2Components_Sister : IBenchmark
    {
        ...
        {
            Context?.Lock();
            Context?.CreateEntities(_entitySet, 0, new Component1(), new Component2());
            Context?.Commit();
        }
    }
}