...
[ArtifactsPath(".benchmark_results/" + nameof(CreateEntityWith4Components<T, TE>))]
[MemoryDiagnoser]

#if CHECK_CACHE_MISSES
[HardwareCounters(BenchmarkDotNet.Diagnosers.HardwareCounter.CacheMisses)]
#endif
public abstract class CreateEntityWith4Components<T, TE> : IBenchmark<T, TE> where T : IBenchmarkContext<TE>
{
