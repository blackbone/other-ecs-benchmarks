...
[ArtifactsPath(".benchmark_results/" + nameof(CreateEntityWith3Components<T, TE>))]
[MemoryDiagnoser]

#if CHECK_CACHE_MISSES
[HardwareCounters(BenchmarkDotNet.Diagnosers.HardwareCounter.CacheMisses)]
#endif
public abstract class CreateEntityWith3Components<T, TE> : IBenchmark<T, TE> where T : IBenchmarkContext<TE>
{
