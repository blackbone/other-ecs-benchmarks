...
[ArtifactsPath(".benchmark_results/" + nameof(CreateEntityWith2RandomComponents<T, TE>))]
[MemoryDiagnoser]
        ...
        for (int _i = 0; _i < _entitySet.Length; _i++) {
            ...
            switch (ArrayExtensions.Rnd.Next() % 4) {
                case 0:
                    ...
                    break;
                case 1:
                    Context.CreateEntities<Component2, Component3>(_tmp, 1, default(Component2), default(Component3));
                    break;
                case 2:
                    Context.CreateEntities<Component3, Component4>(_tmp, 2, default(Component3), default(Component4));
                    break;
                case 3:
