...
[ArtifactsPath(".benchmark_results/" + nameof(ThreeRemoveTwoComponents<T, TE>))]
[MemoryDiagnoser]

#if CHECK_CACHE_MISSES
[HardwareCounters(BenchmarkDotNet.Diagnosers.HardwareCounter.CacheMisses)]
#endif
public abstract class ThreeRemoveTwoComponents<T, TE> : IBenchmark<T, TE> where T : IBenchmarkContext<TE>
{
