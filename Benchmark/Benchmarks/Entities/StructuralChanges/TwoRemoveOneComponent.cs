...
[ArtifactsPath(".benchmark_results/" + nameof(TwoRemoveOneComponent<T, TE>))]
[MemoryDiagnoser]

#if CHECK_CACHE_MISSES
[HardwareCounters(BenchmarkDotNet.Diagnosers.HardwareCounter.CacheMisses)]
#endif
public abstract class TwoRemoveOneComponent<T, TE> : IBenchmark<T, TE> where T : IBenchmarkContext<TE>
{
