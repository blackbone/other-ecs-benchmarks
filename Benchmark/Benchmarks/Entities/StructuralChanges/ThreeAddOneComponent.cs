...
[ArtifactsPath(".benchmark_results/" + nameof(ThreeAddOneComponent<T, TE>))]
[MemoryDiagnoser]

#if CHECK_CACHE_MISSES
[HardwareCounters(BenchmarkDotNet.Diagnosers.HardwareCounter.CacheMisses)]
#endif
public abstract class ThreeAddOneComponent<T, TE> : IBenchmark<T, TE> where T : IBenchmarkContext<TE>
{
    ...
    public void Run()
    {
        Context.AddComponent<Component4>(_entitySet, 1, default(Component4));
    }
