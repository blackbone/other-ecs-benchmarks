...
[ArtifactsPath(".benchmark_results/" + nameof(FourRemoveOneComponent<T, TE>))]
[MemoryDiagnoser]
#if CHECK_CACHE_MISSES
[HardwareCounters(BenchmarkDotNet.Diagnosers.HardwareCounter.CacheMisses)]
#endif
public abstract class FourRemoveOneComponent<T, TE> : IBenchmark<T, TE> where T : IBenchmarkContext<TE>
{
