...
[ArtifactsPath(".benchmark_results/" + nameof(FourRemoveTwoComponents<T>))]
[MemoryDiagnoser]
#if CHECK_CACHE_MISSES
[HardwareCounters(BenchmarkDotNet.Diagnosers.HardwareCounter.CacheMisses)]
#endif
public abstract class FourRemoveTwoComponents<T> : IBenchmark<T> where T : IBenchmarkContext
{
