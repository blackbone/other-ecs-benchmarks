...
[ArtifactsPath(".benchmark_results/" + nameof(FourRemoveTwoComponents<T, TE>))]
[MemoryDiagnoser]
#if CHECK_CACHE_MISSES
[HardwareCounters(BenchmarkDotNet.Diagnosers.HardwareCounter.CacheMisses)]
#endif
public abstract class FourRemoveTwoComponents<T, TE> : IBenchmark<T, TE> where T : IBenchmarkContext<TE>
{
    ...
    public void Run()
    {
        Context.RemoveComponent<Component3, Component4>(_entitySet, 1);
    }
