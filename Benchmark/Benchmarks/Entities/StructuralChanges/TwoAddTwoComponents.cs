...
[ArtifactsPath(".benchmark_results/" + nameof(TwoAddTwoComponents<T, TE>))]
[MemoryDiagnoser]

#if CHECK_CACHE_MISSES
[HardwareCounters(BenchmarkDotNet.Diagnosers.HardwareCounter.CacheMisses)]
#endif
public abstract class TwoAddTwoComponents<T, TE> : IBenchmark<T, TE> where T : IBenchmarkContext<TE>
{
    ...
    public void Run()
    {
        Context.AddComponent<Component3, Component4>(_entitySet, 1, default(Component3), default(Component4));
    }
