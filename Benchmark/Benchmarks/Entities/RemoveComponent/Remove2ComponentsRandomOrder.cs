...
[ArtifactsPath(".benchmark_results/" + nameof(Remove2ComponentsRandomOrder<T, TE>))]
[MemoryDiagnoser]

#if CHECK_CACHE_MISSES
[HardwareCounters(BenchmarkDotNet.Diagnosers.HardwareCounter.CacheMisses)]
#endif
public abstract class Remove2ComponentsRandomOrder<T, TE> : IBenchmark<T, TE> where T : class, IBenchmarkContext<TE>
{
