...
[ArtifactsPath(".benchmark_results/" + nameof(Add2RandomComponentsRandomOrder<T, TE>))]
[MemoryDiagnoser]

#if CHECK_CACHE_MISSES
[HardwareCounters(BenchmarkDotNet.Diagnosers.HardwareCounter.CacheMisses)]
#endif
public abstract class Add2RandomComponentsRandomOrder<T, TE> : IBenchmark<T, TE> where T : IBenchmarkContext<TE>
{
