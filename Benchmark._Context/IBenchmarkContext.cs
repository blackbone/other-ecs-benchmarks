...
public interface IBenchmarkContext<E> : IBenchmarkContext
{
    ...
    public void Warmup<T1>(in int poolId)
        where T1 : struct, MorpehComponent, DragonComponent, FrifloComponent, StaticEcsComponent;
    ...
    public void Warmup<T1, T2>(in int poolId)
        where T1 : struct, MorpehComponent, DragonComponent, FrifloComponent, StaticEcsComponent
        where T2 : struct, MorpehComponent, DragonComponent, FrifloComponent, StaticEcsComponent;
    ...
    public void Warmup<T1, T2, T3>(in int poolId)
        where T1 : struct, MorpehComponent, DragonComponent, FrifloComponent, StaticEcsComponent
        where T2 : struct, MorpehComponent, DragonComponent, FrifloComponent, StaticEcsComponent
        where T3 : struct, MorpehComponent, DragonComponent, FrifloComponent, StaticEcsComponent;
    ...
    public void Warmup<T1, T2, T3, T4>(in int poolId)
        ...
        where T2 : struct, MorpehComponent, DragonComponent, FrifloComponent, StaticEcsComponent
        where T3 : struct, MorpehComponent, DragonComponent, FrifloComponent, StaticEcsComponent
        where T4 : struct, MorpehComponent, DragonComponent, FrifloComponent, StaticEcsComponent;
