...
public sealed class TinyEcsContext(int entityCount = 4096) : IBenchmarkContext
{
    ...
    public void Warmup<T1, T2>(in int poolId) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent where T2 : struct, MorpehComponent, DragonComponent, XenoComponent
        => _queries![poolId] = _world!.QueryBuilder().With<T1>().With<T2>().Build();

    public void Warmup<T1, T2, T3>(in int poolId) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent where T2 : struct, MorpehComponent, DragonComponent, XenoComponent where T3 : struct, MorpehComponent, DragonComponent, XenoComponent
        => _queries![poolId] = _world!.QueryBuilder().With<T1>().With<T2>().With<T3>().Build();

    public void Warmup<T1, T2, T3, T4>(in int poolId) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent where T2 : struct, MorpehComponent, DragonComponent, XenoComponent where T3 : struct, MorpehComponent, DragonComponent, XenoComponent where T4 : struct, MorpehComponent, DragonComponent, XenoComponent
    ...
    public void CreateEntities<T1>(in Array entitySet, in int poolId = -1, in T1 c1 = default) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent
    {
        var entities = (EntityView[])entitySet;
        for (var i = 0; i < entities.Length; i++)
    ...
    public void CreateEntities<T1, T2>(in Array entitySet, in int poolId = -1, in T1 c1 = default, in T2 c2 = default) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent where T2 : struct, MorpehComponent, DragonComponent, XenoComponent
    {
        var entities = (EntityView[])entitySet;
        for (var i = 0; i < entities.Length; i++)
    ...
    public void CreateEntities<T1, T2, T3>(in Array entitySet, in int poolId = -1, in T1 c1 = default, in T2 c2 = default,
        in T3 c3 = default) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent where T2 : struct, MorpehComponent, DragonComponent, XenoComponent where T3 : struct, MorpehComponent, DragonComponent, XenoComponent
    {
        var entities = (EntityView[])entitySet;
        for (var i = 0; i < entities.Length; i++)
    ...
    public void CreateEntities<T1, T2, T3, T4>(in Array entitySet, in int poolId = -1, in T1 c1 = default, in T2 c2 = default,
        in T3 c3 = default, in T4 c4 = default) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent where T2 : struct, MorpehComponent, DragonComponent, XenoComponent where T3 : struct, MorpehComponent, DragonComponent, XenoComponent where T4 : struct, MorpehComponent, DragonComponent, XenoComponent
    {
        var entities = (EntityView[])entitySet;
        for (var i = 0; i < entities.Length; i++)
    ...
    public void AddComponent<T1>(in Array entitySet, in int poolId = -1, in T1 c1 = default) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent
    {
        var entities = (EntityView[])entitySet;
        for (var i = 0; i < entities.Length; i++)
            entities[i].Set(c1);
    ...
    public void AddComponent<T1, T2>(in Array entitySet, in int poolId = -1, in T1 c1 = default, in T2 c2 = default) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent where T2 : struct, MorpehComponent, DragonComponent, XenoComponent
    {
        var entities = (EntityView[])entitySet;
        for (var i = 0; i < entities.Length; i++)
    ...
    public void RemoveComponent<T1, T2>(in Array entitySet, in int poolId = -1) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent where T2 : struct, MorpehComponent, DragonComponent, XenoComponent
    {
        var entities = (EntityView[])entitySet;
        for (var i = 0; i < entities.Length; i++)
    ...
    public void RemoveComponent<T1, T2, T3>(in Array entitySet, in int poolId = -1) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent where T2 : struct, MorpehComponent, DragonComponent, XenoComponent where T3 : struct, MorpehComponent, DragonComponent, XenoComponent
    {
        var entities = (EntityView[])entitySet;
        for (var i = 0; i < entities.Length; i++)
    ...
    public int CountWith<T1, T2>(in int poolId) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent where T2 : struct, MorpehComponent, DragonComponent, XenoComponent
        => _queries![poolId].Count();

    public int CountWith<T1, T2, T3>(in int poolId) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent where T2 : struct, MorpehComponent, DragonComponent, XenoComponent where T3 : struct, MorpehComponent, DragonComponent, XenoComponent
        => _queries![poolId].Count();

    public int CountWith<T1, T2, T3, T4>(in int poolId) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent where T2 : struct, MorpehComponent, DragonComponent, XenoComponent where T3 : struct, MorpehComponent, DragonComponent, XenoComponent where T4 : struct, MorpehComponent, DragonComponent, XenoComponent
        => _queries![poolId].Count();
    ...
    public bool GetSingle<T1, T2>(in object? entity, in int poolId, ref T1 c1, ref T2 c2) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent where T2 : struct, MorpehComponent, DragonComponent, XenoComponent
    {
        if (entity == null) return false;
    ...
    public bool GetSingle<T1, T2, T3>(in object? entity, in int poolId, ref T1 c1, ref T2 c2, ref T3 c3) where T1 : struct, MorpehComponent, DragonComponent, XenoComponent where T2 : struct, MorpehComponent, DragonComponent, XenoComponent where T3 : struct, MorpehComponent, DragonComponent, XenoComponent
    {
        if (entity == null) return false;
